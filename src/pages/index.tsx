  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless HR processes with HR Management Application - your reliable partner in nurturing talent and driving organizational success."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless HR processes with HR Management Application - your reliable partner in nurturing talent and driving organizational success.`}
            </Text>
            <Box
