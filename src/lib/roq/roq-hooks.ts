...
export function useProjectsFindMany<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useProjectsFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.projects.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useProjectsCount<T extends Prisma.projectsCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.projectsCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useProjectsCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.projects.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useProjectsFindManyWithCount<
  T extends Prisma.projectsFindManyArgs,
  R extends { data: GetFindResult<Prisma.$projectsPayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.projectsFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useProjectsFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.projects.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useProjectsFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useProjectsFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.projects.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
